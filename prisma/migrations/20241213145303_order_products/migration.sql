...
-- AddForeignKey
ALTER TABLE "OrderProducts" ADD CONSTRAINT "OrderProducts_prodcutId_fkey" FOREIGN KEY ("prodcutId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
